...
boondock_saints = media.Movie("Boondock Saints",
                              "Vigilante brothers",
                              "https://upload.wikimedia.org/wikipedia/en/thumb/1/1b/The_Boondock_Saints_poster.jpeg/215px-The_Boondock_Saints_poster.jpeg",
                              "https://www.youtube.com/watch?v=ydXojYfCF3I")
rear_window = media.Movie("Rear Window",
                          "Catching murderers",
                          "https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/Rear_Window_film_poster.jpg/225px-Rear_Window_film_poster.jpg",
                          "https://www.youtube.com/watch?v=6kCcZCMYw38")
donnie_darko = media.Movie("Donnie Darko",
                           "What it means to be alive",
                           "https://upload.wikimedia.org/wikipedia/en/thumb/d/db/Donnie_Darko_poster.jpg/220px-Donnie_Darko_poster.jpg",
                           "https://www.youtube.com/watch?v=ZZyBaFYFySk")
sixth_sense = media.Movie("The Sixth Sense",
                          "Dark secrets",
                          "https://upload.wikimedia.org/wikipedia/en/thumb/6/66/The_sixth_sense.jpg/220px-The_sixth_sense.jpg",
